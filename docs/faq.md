...
### What is Open Referral? {#what-is-open-referral}
...
### Who started Open Referral? {#who-started-open-referral}
...
### How is this project relevant to me? {#how-is-this-project-relevant-to-me}
...
### If I maintain a community resource directory — or if I partner with an organization that does — how would I get started? {#if-i-maintain-a-community-resource-directory-—-or-if-i-partner-with-an-organization-that-does-—-how-would-i-get-started}
...
### How are decisions made about the Open Referral specifications? {#how-are-decisions-made-about-the-open-referral-specifications}
...
### What is the Human Services Data Specification (HSDS)? {#what-is-the-human-services-data-specification-hsds}
...
### What is not in the Human Services Data Specification (HSDS)? {#what-is-not-in-the-human-services-data-specification-hsds}
...
### What is the format of the HSDS? Why CSV? {#what-is-the-format-of-the-hsds-why-csv}
...
### How do you address the matter of taxonomy (of types of services and situations)? {#how-do-you-address-the-matter-of-taxonomy-of-types-of-services-and-situations}
...
### How does Open Referral handle eligibility criteria? {#how-does-open-referral-handle-eligibility-criteria}
...
### What if I collect important information that isn't included in the Human Service Data specification? {#what-if-i-collect-important-information-that-isn't-included-in-the-human-service-data-specification}
...
### What if the Human Service Data Specification requires kinds of information that I don't collect? {#what-if-the-human-service-data-specification-requires-kinds-of-information-that-i-don't-collect}
...
### What if I need help collecting this data in the first place? {#what-if-i-need-help-collecting-this-data-in-the-first-place}
...
### Who has adapted this project and can I see examples? {#who-has-adapted-this-project-and-can-i-see-examples}
...
### Who do I contact if I need help with this project? {#who-do-i-contact-if-i-need-help-with-this-project}
...
### What languages is this project in? {#what-languages-is-this-project-in}
...
### If I wanted to help with this project, what is the best way to do that? {#if-i-wanted-to-help-with-this-project-what-is-the-best-way-to-do-that}
...
### Is the project in active development? {#is-the-project-in-active-development}
...
### What is the licensing on this project? {#what-is-the-licensing-on-this-project}
