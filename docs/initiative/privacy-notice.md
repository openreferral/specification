...
Data controller: <br/>
Open Referral, c/o Bloom Coproductions LLC, Florida Registered Company: L16000226287, [info@openreferral.org](mailto:info@openreferral.org). <br/>
...
The data controller (Open Referral) is based in the USA.
