...
CREATE TABLE `contact` (
  ...
  CONSTRAINT `contact_ibfk_1` FOREIGN KEY (`service_at_location_id`) REFERENCES `service_at_location` (`id`),
  CONSTRAINT `contact_ibfk_2` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`),
  CONSTRAINT `contact_ibfk_3` FOREIGN KEY (`service_id`) REFERENCES `service` (`id`),
...
CREATE TABLE `funding` (
  ...
  KEY `organization_id` (`organization_id`),
  KEY `service_id` (`service_id`),
  CONSTRAINT `funding_ibfk_1` FOREIGN KEY (`organization_id`) REFERENCES `organization` (`id`),
  CONSTRAINT `funding_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `service` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `language` (
  ...
  CONSTRAINT `language_ibfk_3` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `phone` (
  ...
  CONSTRAINT `phone_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `service` (`id`),
  CONSTRAINT `phone_ibfk_3` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`),
  CONSTRAINT `phone_ibfk_4` FOREIGN KEY (`service_at_location_id`) REFERENCES `service_at_location` (`id`),
  CONSTRAINT `phone_ibfk_5` FOREIGN KEY (`organization_id`) REFERENCES `organization` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `service_at_location` (
  ...
  CONSTRAINT `service_at_location_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `service` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
