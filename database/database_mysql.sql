...
CREATE TABLE `schedule` (
  ...
  `count` int DEFAULT NULL COMMENT 'iCal - The number of times that the event occurs. Use this instead of ''until'', if appropriate.',
  `wkst` varchar(250) DEFAULT NULL COMMENT 'iCal - The day on which the week starts, eg MO.',
