...
CREATE TABLE `contact` (
  ...
  CONSTRAINT `contact_ibfk_2` FOREIGN KEY (`service_at_location_id`) REFERENCES `service_at_location` (`id`),
  CONSTRAINT `contact_ibfk_3` FOREIGN KEY (`organization_id`) REFERENCES `organization` (`id`),
  CONSTRAINT `contact_ibfk_4` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `schedule` (
  ...
  KEY `location_id` (`location_id`),
  KEY `service_id` (`service_id`),
  CONSTRAINT `schedule_ibfk_1` FOREIGN KEY (`service_at_location_id`) REFERENCES `service_at_location` (`id`),
  CONSTRAINT `schedule_ibfk_2` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`),
  CONSTRAINT `schedule_ibfk_3` FOREIGN KEY (`service_id`) REFERENCES `service` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
